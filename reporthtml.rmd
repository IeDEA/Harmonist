...
sumGroups <- kbl(groupSummary, col.names = c(groupVar,"Patients"), caption = paste0(groupVar, " in Dataset"),longtable = T, format = "html") %>% kable_styling(full_width = FALSE, position = "left", "bordered")
```

...
## `r knitr::include_graphics("iedeaLogoSmall.png")` Harmonist Data Toolkit Report for `r groupVar` `r program`
...
if (params$includeDataSummary){
  if (!is.null(params$datasetSummary$statsSummaryTable)){
    cat("### Summary statistics from uploaded tables", groupVar, program)

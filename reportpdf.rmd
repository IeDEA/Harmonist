...
sumProgs <- kable(temp, format = "latex",  caption = paste0(groupVar, " in Dataset"),longtable = T, booktabs = T) %>%
...
sumVars <- kable(tableToShow, "latex",caption = "Summary of Uploaded IeDEA Tables", longtable = T, booktabs = T) %>% 
